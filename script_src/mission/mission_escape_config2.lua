...
resetBossToPlayerDist = 1000		-- 멀리 떨어지면 소환되는 거리

resetStartPoint		= false
resetToBossPosition	= true		-- 보스와 멀어지면 강제 워프하는가?
